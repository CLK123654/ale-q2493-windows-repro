...
ROOT=Path(__file__).resolve().parents[1];TASK=ROOT/"task";expected=json.loads((ROOT/"qa/expected_hashes.json").read_text());actual={n:hashlib.sha256((TASK/n).read_bytes()).hexdigest() for n in expected}
